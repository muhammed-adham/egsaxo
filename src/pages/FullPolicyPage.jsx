...
const FullPolicyPage = () => (
  <div className="privacy-section">
    ...
    <p className="privacy-description">
      This Privacy Policy describes how EGSaxo ("we", "us", or "our") collects,
    ...
    <div className="privacy__list-container">
      ...
      <ul className="privacy-list">
        <li>
          ...
          address, phone number, and payment details (if applicable).
        </li>
        <li>
      ...
      <ul className="privacy-list">
        ...
        <li>
          To communicate with you regarding your orders, account, or customer
          service inquiries.
        </li>
        <li>To improve our website, products, and services.</li>
        <li>
          To send you updates, promotions, and marketing communications (you may
          opt out at any time).
        </li>
        <li>To comply with legal obligations and prevent fraud.</li>
      </ul>

      <h2 className="privacy-subheading">How We Share Your Information</h2>
      <ul className="privacy-list">
        <li>
        ...
        <li>
          We may share your information with trusted service providers (e.g.,
          payment processors, shipping partners) only as necessary to fulfill
          your order.
        </li>
        <li>
      ...
      <h2 className="privacy-subheading">Your Rights & Choices</h2>
      <ul className="privacy-list">
        <li>
          You may access, update, or delete your personal information by{" "}
          <a href="/contact" className="privacy-highlight">
            contacting us here
          </a>
          .
        </li>
